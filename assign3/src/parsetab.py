...
_lr_productions = [
  ...
  ('Expression -> UnaryExpr','Expression',1,'p_expr','parser.py',294),
  ('Expression -> Expression BinaryOp Expression','Expression',3,'p_expr','parser.py',295),
  ('BinaryOp -> LOGICAL_OR','BinaryOp',1,'p_binary_op','parser.py',302),
  ('BinaryOp -> LOGICAL_AND','BinaryOp',1,'p_binary_op','parser.py',303),
  ('BinaryOp -> RelOp','BinaryOp',1,'p_binary_op','parser.py',304),
  ('BinaryOp -> AddOp','BinaryOp',1,'p_binary_op','parser.py',305),
  ('BinaryOp -> MulOp','BinaryOp',1,'p_binary_op','parser.py',306),
  ('RelOp -> EQUALS','RelOp',1,'p_rel_op','parser.py',315),
  ('RelOp -> NOT_ASSIGN','RelOp',1,'p_rel_op','parser.py',316),
  ('RelOp -> LESSER','RelOp',1,'p_rel_op','parser.py',317),
  ('RelOp -> GREATER','RelOp',1,'p_rel_op','parser.py',318),
  ('RelOp -> LESS_EQUALS','RelOp',1,'p_rel_op','parser.py',319),
  ('RelOp -> MORE_EQUALS','RelOp',1,'p_rel_op','parser.py',320),
  ('AddOp -> PLUS','AddOp',1,'p_add_op','parser.py',335),
  ('AddOp -> MINUS','AddOp',1,'p_add_op','parser.py',336),
  ('AddOp -> OR','AddOp',1,'p_add_op','parser.py',337),
  ('AddOp -> XOR','AddOp',1,'p_add_op','parser.py',338),
  ('MulOp -> STAR','MulOp',1,'p_mul_op','parser.py',349),
  ('MulOp -> DIVIDE','MulOp',1,'p_mul_op','parser.py',350),
  ('MulOp -> MOD','MulOp',1,'p_mul_op','parser.py',351),
  ('MulOp -> LSHIFT','MulOp',1,'p_mul_op','parser.py',352),
  ('MulOp -> RSHIFT','MulOp',1,'p_mul_op','parser.py',353),
  ('MulOp -> AND','MulOp',1,'p_mul_op','parser.py',354),
  ('MulOp -> AND_XOR','MulOp',1,'p_mul_op','parser.py',355),
  ('UnaryOp -> PLUS','UnaryOp',1,'p_unary_op','parser.py',359),
  ('UnaryOp -> MINUS','UnaryOp',1,'p_unary_op','parser.py',360),
  ('UnaryOp -> NOT','UnaryOp',1,'p_unary_op','parser.py',361),
  ('UnaryOp -> XOR','UnaryOp',1,'p_unary_op','parser.py',362),
  ('UnaryOp -> STAR','UnaryOp',1,'p_unary_op','parser.py',363),
  ('UnaryOp -> AND','UnaryOp',1,'p_unary_op','parser.py',364),
  ('UnaryExpr -> PrimaryExpr','UnaryExpr',1,'p_unary_expr','parser.py',368),
  ('UnaryExpr -> UnaryOp UnaryExpr','UnaryExpr',2,'p_unary_expr','parser.py',369),
  ('ArrayType -> LSQUARE ArrayLength RSQUARE ElementType','ArrayType',4,'p_array_type','parser.py',379),
  ('ArrayLength -> Expression','ArrayLength',1,'p_array_length','parser.py',383),
  ('ElementType -> Type','ElementType',1,'p_element_type','parser.py',387),
  ('StructType -> STRUCT LCURL FieldDeclRep RCURL','StructType',4,'p_struct_type','parser.py',396),
  ('FieldDeclRep -> FieldDeclRep FieldDecl SEMICOLON','FieldDeclRep',3,'p_field_decl_rep','parser.py',400),
  ('FieldDeclRep -> epsilon','FieldDeclRep',1,'p_field_decl_rep','parser.py',401),
  ('FieldDecl -> IdentifierList Type TagOpt','FieldDecl',3,'p_field_decl','parser.py',408),
  ('TagOpt -> Tag','TagOpt',1,'p_TagOpt','parser.py',412),
  ('TagOpt -> epsilon','TagOpt',1,'p_TagOpt','parser.py',413),
  ('Tag -> STRING','Tag',1,'p_Tag','parser.py',417),
  ('PointerType -> epsilon','PointerType',1,'p_point_type','parser.py',428),
  ('Signature -> epsilon','Signature',1,'p_sign','parser.py',435),
  ('Statement -> epsilon','Statement',1,'p_stat','parser.py',440),
  ('PrimaryExpr -> epsilon','PrimaryExpr',1,'p_prim_expr','parser.py',445),
  ('epsilon -> <empty>','epsilon',0,'p_empty','parser.py',449),
]
