...
def findBlocks():
    ...
    for index, instr in enumerate(ir):
        ...
        if instr.type == 'goto' or instr.type == 'ifgoto' or instr.type == 'callint' or instr.type == 'callvoid' or instr.type == 'retvoid' or instr.type == 'retint' or instr.type == 'print' or instr.type == 'scan':
